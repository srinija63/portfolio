...
const CONTACT_METHODS: ContactMethod[] = [
  ...
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 93910 34637',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/919391034637',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/srinija-abburi',
    href: 'https://www.linkedin.com/in/srinija-abburi/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@srinija63',
    href: 'https://github.com/srinija63',
  },
];
